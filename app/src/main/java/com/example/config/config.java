...
public class config {
    ...
    public static final String main = "http://battleworld.in/netklix";
    //    public static String mainurl = "http://battleworld.in/netklix/play/";
    public static final String mainurl = "http://battleworld.in/netklix/";
    ...
    public static final String appurl = "http://battleworld.in/netklix/app.apk";
